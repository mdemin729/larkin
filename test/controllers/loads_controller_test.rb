...
class LoadsControllerTest < ActionController::TestCase
  ...
  test "should create load" do
    assert_difference('Load.count') do
      post :create, load: { delivery_date: @load.delivery_date, delivery_shift: @load.delivery_shift, driver_id: @load.driver_id }
    end
  ...
  test "should update load" do
    patch :update, id: @load, load: { delivery_date: @load.delivery_date, delivery_shift: @load.delivery_shift, driver_id: @load.driver_id }
    assert_redirected_to load_path(assigns(:load))
  end
